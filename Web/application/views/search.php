          ...
          <div class="hero">
            <form id="myForm" method="get" name="bing" oninput="return bingAutosuggest(this.p.value,)">
              <div id="searchBox" class="d-flex">
                ...
                <input type="text" class="search-input" name="p" id="textarea" placeholder="Your Searches Fight Hunger..." value="<?php echo $query;?>" onkeyup="showButton()" autocomplete="off">
                <img src="<?php echo base_url().'assets/';?>images/x-1.svg" class="x-icon" id="x" onclick="resetForm()" style="visibility: hidden;">
  ...
  <div class="section-9 wf-section">
    <div class="w-container">
      <div class="columns-4 w-row">
        ...
        <div class="w-col w-col-6">
          <ul role="list" class="list-2">
            ...
            <script>
                ...
                bingAutosuggest(document.getElementById("textarea").value);
                $('#list').on("click","li", function()
                { 
                    var url_search_cnt = "<?php echo base_url().'search/search_cnt';?>";
                    $.ajax({
                            type: "POST",
                            url: url_search_cnt,
                            data: null,
        ...
        myForm.classList.toggle("active-form");
